...
public class CustomCombatAction extends DefaultMutableTreeNode {
  ...
  public CustomCombatAction(
      final int index, final String indent, final String action, boolean isMacro) {
    super(action, false);
    ...
    if (this.action.equals("default")) {
      ...
      this.sectionReference =
          CombatActionManager.encounterKey(this.action.substring(8).trim().toLowerCase());
    } else {
