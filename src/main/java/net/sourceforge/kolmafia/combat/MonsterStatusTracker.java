...
public class MonsterStatusTracker {
  ...
  public static final boolean willUsuallyDodge(final int attackModifier) {
    ...
    return MonsterStatusTracker.monsterData.willUsuallyDodge(
        MonsterStatusTracker.attackModifier + attackModifier);
  }
  ...
  public static final boolean willUsuallyMiss(final int defenseModifier) {
    ...
    return MonsterStatusTracker.monsterData.willUsuallyMiss(
        MonsterStatusTracker.defenseModifier + defenseModifier);
  }
