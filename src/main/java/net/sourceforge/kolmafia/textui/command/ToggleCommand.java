...
public class ToggleCommand extends AbstractCommand {
  ...
  // The plan is to have this be a more generic command for toggling effects, in case that becomes
  // relevant.
  // Since there is only a single pair of effects to toggle currently, the parameter isn't actually
  // used.
  @Override
