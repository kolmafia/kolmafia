...
public class SentMessageEntry extends HistoryEntry {
  private static final Pattern DOJAX_PATTERN = Pattern.compile("<!--js\\(\\s*dojax\\((.*?)\\)-->");
  ...
  public SentMessageEntry(
      final String responseText, final long localLastSeen, boolean isRelayRequest) {
