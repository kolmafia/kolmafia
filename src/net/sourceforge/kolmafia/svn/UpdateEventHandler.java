...
public class UpdateEventHandler implements ISVNEventHandler {
	...
	public void handleEvent(SVNEvent event, double progress) {
		...
		if (action == SVNEventAction.UPDATE_ADD) {
			...
			RequestLogger.printLine("Fetching external item into '"
					+ event.getFile().getAbsolutePath() + "'");
			RequestLogger.printLine("External at revision "
					+ event.getRevision());
			return;
		...
		RequestLogger.printLine(pathChangeType + propertiesChangeType
				+ lockLabel + "       " + printMe);
	}
