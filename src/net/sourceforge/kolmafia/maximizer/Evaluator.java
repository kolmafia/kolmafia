 ...
 *
 * <p>The evaluator is the semantic boundary between query terms and candidate/search code. It owns
 * the primary and tiebreaker expressions, calculates scores and constraint outcomes, and exposes
 * the resulting equipment requirements. It delegates parsing and stored term state to {@link
 * MaximizerTermRegistry}, Codpiece candidate ranking to {@link CodpieceEvaluator}, and equipment
 * compilation and traversal to {@link EquipmentSearchRunner}.
 */
...
public class Evaluator {
  ...
  // Virtual ranking buckets reuse otherwise independent child slots. They keep one-hand weapons
  // and melee/ranged offhands available even when their isolated ranks lose to incompatible gear.
