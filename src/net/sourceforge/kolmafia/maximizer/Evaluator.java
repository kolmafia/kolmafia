...
public class Evaluator {
  ...
  private static final String TIEBREAKER =
      "1 familiar weight, 1 familiar experience, 1 initiative, 5 exp, 1 item, 1 meat, 0.1 DA 1000"
          + " max, 1 DR, 0.5 all res, -10 mana cost, 1.0 mus, 0.5 mys, 1.0 mox, 1.5 mainstat, 1 HP,"
          + " 1 MP, 1 weapon damage, 1 ranged damage, 1 spell damage, 1 cold damage, 1 hot damage,"
          + " 1 sleaze damage, 1 spooky damage, 1 stench damage, 1 cold spell damage, 1 hot spell"
          + " damage, 1 sleaze spell damage, 1 spooky spell damage, 1 stench spell damage, -1"
          + " fumble, 1 HP regen max, 3 MP regen max, 1 critical hit percent, 0.1 food drop, 0.1"
          + " booze drop, 0.1 hat drop, 0.1 weapon drop, 0.1 offhand drop, 0.1 shirt drop, 0.1"
          + " pants drop, 0.1 accessory drop, 1 DB combat damage, 0.1 sixgun damage";
