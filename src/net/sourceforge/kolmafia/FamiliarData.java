	...
	implements Comparable<FamiliarData>
{
	...
	// <center>Current Familiar:<br><img  src="https://s3.amazonaws.com/images.kingdomofloathing.com/otherimages/righthandbody.png" width=30 height=30 border=0><br><b>Manny Frashins</b><br>1-pound Left-Hand Man (0 experience, 0 kills)<p><form name=rename action=familiar.php method=post><input type=hidden name=action value="rename"><input type=hidden name=pwd value='d6bcda5f6ff05d0c71b6ccd1702dbacd'>Change your Familiar's Name:<br><input class=text type=text size=40 maxlength=40 name=newname value="Manny Frashins"> <input class=button type=submit value="Rename"></form>

	// <center>Current Familiar:<br><div style="position: relative; height: 50px; width: 30px"><img onClick='fam(278)' style="position: absolute; left: -2px; bottom: 25px;" src="https://s3.amazonaws.com/images.kingdomofloathing.com/itemimages/uvcompass.gif" width=30 height=30 border=0 ><img style="position: absolute; left: 0; bottom: 0;" src="https://s3.amazonaws.com/images.kingdomofloathing.com/otherimages/righthandbody.png" width=30 height=30 border=0></div><br><b>Manny Frashins</b><br>1-pound Left-Hand Man (0 experience, 0 kills)<table><tr><td valign=center>Equipment:</td><td><img src="https://s3.amazonaws.com/images.kingdomofloathing.com/itemimages/uvcompass.gif" class=hand onClick='descitem(323401194)'></td><td valign=center>UV-resistant compass <font size=1><a href='inv_equip.php?pwd=e7baebb793602dd11b8d966f095336c4&action=unequip&type=familiarequip&terrarium=1'>[unequip]</a></font></td></tr></table><p><form name=rename action=familiar.php method=post><input type=hidden name=action value="rename"><input type=hidden name=pwd value='e7baebb793602dd11b8d966f095336c4'>Change your Familiar's Name:<br><input class=text type=text size=40 maxlength=40 name=newname value="Manny Frashins"> <input class=button type=submit value="Rename"></form>

	// <center>Current Familiar:<br><span style="display: block; position: relative; height: 30px; width: 55px" onClick='fam(279)'><img src="https://s3.amazonaws.com/images.kingdomofloathing.com/otherimages/camelfam_left.gif" width=20 height=30 border=0><img src="https://s3.amazonaws.com/images.kingdomofloathing.com/otherimages/camelfam_right.gif" width=25 height=30 border=0></span><br><b>Gogarth</b><br>1-pound Melodramedary (0 experience, 0 kills)<table><tr><td valign=center>Equipment:</td><td><img src="https://s3.amazonaws.com/images.kingdomofloathing.com/itemimages/hookah.gif" class=hand onClick='descitem(279445768)'></td><td valign=center>ittah bittah hookah <font size=1><a href='inv_equip.php?pwd=276c8f0c21e1b2a96a410d3a6ebd34d0&action=unequip&type=familiarequip&terrarium=1'>[unequip]</a></font></td><td><a href='familiar.php?action=lockequip&pwd=276c8f0c21e1b2a96a410d3a6ebd34d0'><img src="https://s3.amazonaws.com/images.kingdomofloathing.com/itemimages/openpadlock.gif" class=hand title='This Familiar Equipment is Unlocked'></a></td><td valign=top><font size=-1><b><a class=nounder href='javascript:doc("famequiplock");'>?</a></b></font></td></tr></table><p><form name=rename action=familiar.php method=post><input type=hidden name=action value="rename"><input type=hidden name=pwd value='276c8f0c21e1b2a96a410d3a6ebd34d0'>Change your Familiar's Name:<br><input class=text type=text size=40 maxlength=40 name=newname value="Gogarth"> <input class=button type=submit value="Rename"></form>
	...
	private static final Pattern CURRENT_FAMILIAR_PATTERN =
		Pattern.compile( ".*?(?:onClick='fam\\((\\d+)\\)')? .*?src=\"[^>]*?(?:images.kingdomofloathing.com|/images)/(?:item|other)images/([^\"]*?)\".*?<b>(.*?)</b>.*?\\d+-pound (.*?) \\(([\\d,]+) (?:exp|experience|candy|candies)?, ([\\d,]+) kills?\\)(.*?)(?:</form)>" );
	...
	// <tr class="frow " data-attack="1" data-other="1"><td valign=center><input type=radio name=newfam value=278></td><td valign=center><img  src="https://s3.amazonaws.com/images.kingdomofloathing.com/otherimages/righthandbody.png" width=30 height=30 border=0></td><td valign=top style='padding-top: .45em;'><b>Manny Frashins</b>, the 14-pound Left-Hand Man (210 exp, 384 kills) <font size="1"><br />&nbsp;&nbsp;&nbsp;&nbsp;<a class="fave" href="familiar.php?group=0&action=fave&famid=278&pwd=e7d9515eca111b1c36980671f7d1312c">[unfavorite]</a>&nbsp;&nbsp;<a class="fave" href="familiar.php?&action=newfam&newfam=278&pwd=e7d9515eca111b1c36980671f7d1312c">[take with you]</a></font></td></tr>

	// <tr class="frow " data-stats="1" data-hp_restore="1" data-mp_restore="1" data-other="1"><td valign=center><input type=radio name=newfam value=279></td><td valign=center><span style="display: block; position: relative; height: 30px; width: 55px" onClick='fam(279)'><img src="https://s3.amazonaws.com/images.kingdomofloathing.com/otherimages/camelfam_left.gif" width=20 height=30 border=0><img src="https://s3.amazonaws.com/images.kingdomofloathing.com/otherimages/camelfam_right.gif" width=25 height=30 border=0></span></td><td valign=top style='padding-top: .45em;'><b>Gogarth</b>, the 1-pound Melodramedary (0 exp, 0 kills) <font size="1"><br />&nbsp;&nbsp;&nbsp;&nbsp;<a class="fave" href="familiar.php?group=0&action=fave&famid=279&pwd=e7d9515eca111b1c36980671f7d1312c">[unfavorite]</a>&nbsp;&nbsp;<a class="fave" href="familiar.php?&action=newfam&newfam=279&pwd=e7d9515eca111b1c36980671f7d1312c">[take with you]</a></font></td></tr>
