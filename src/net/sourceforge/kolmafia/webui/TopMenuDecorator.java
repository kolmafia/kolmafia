...
public abstract class TopMenuDecorator {
  ...
  private static void addFancyScriptMenus(final StringBuffer buffer, final String location) {
    ...
    menuBuffer.append(
        "<div style='position: absolute; z-index: 5; top: 40px; right: 0px; border-width: 1px;"
            + " color:#000000'>");
  ...
  private static void mafiatizeFunctionMenu(final StringBuffer buffer) {
    ...
    StringUtilities.singleStringReplace(
        ...
        "<option value=\"inventory.php?which=1\">Consumables</option><option"
            + " value=\"inventory.php?which=2\">Equipment</option><option"
            + " value=\"inventory.php?which=3\">Misc Items</option><option"
            + " value=\"sellstuff.php\">Sell Stuff</option>");
