...
public class IslandDecorator {
  ...
  public static final void decorateBigIsland(final String url, final StringBuffer buffer) {
    ...
    int tableIndex =
        buffer.indexOf(
            "<tr><td style=\"color: white;\" align=center bgcolor=blue><b>The Mysterious Island of"
                + " Mystery</b></td>");
    if (tableIndex != -1) {
  ...
  public static final void decorateArena(final String urlString, final StringBuffer buffer) {
    ...
    if (buffer.indexOf("value=\"concert\"") == -1) {
      ...
      int tableIndex =
          buffer.indexOf(
              "<tr><td style=\"color: white;\" align=center bgcolor=blue><b>Mysterious Island"
                  + " Arena</b></td>");
      if (tableIndex != -1) {
  ...
  public static final void decorateNunnery(final String urlString, final StringBuffer buffer) {
    ...
    int tableIndex =
        buffer.indexOf(
            "<tr><td style=\"color: white;\" align=center bgcolor=blue><b>Our Lady of Perpetual"
                + " Indecision</b></td>");
    if (tableIndex == -1) {
      return;
    }
