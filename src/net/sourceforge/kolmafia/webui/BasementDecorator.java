...
public class BasementDecorator {
  ...
  public static final void addBasementSpoilers(final StringBuffer buffer) {
    ...
    changes.append(
        "<tr><td style=\"width:90%;\"><select id=\"gear\" style=\"width: 100%;\"><option"
            + " value=\"none\">- change your equipment -</option>");
    ...
    changes.append(
        "</select></td><td>&nbsp;</td><td style=\"vertical-align:top; text-align:left;\"><input"
            + " type=\"button\" value=\"exec\" onClick=\"changeBasementGear();\"></td></tr>");
