...
public class TCRSDatabase {
  ...
  protected static List<Entry<String, String>> EQUIPMENT_MODIFIERS =
      List.<Entry<String, String>>of(
          ...
          // The four expanded meta-enchantments. The adjectives and their position here are guesses
          // - the
          // point is the expansions, since each one is a single enchantment that Mafia splits into
          // a
          ...
          Map.entry(
              "of regeneration",
              "HP Regen Min: 3, HP Regen Max: 5, MP Regen Min: 3, MP Regen Max: 5"));
