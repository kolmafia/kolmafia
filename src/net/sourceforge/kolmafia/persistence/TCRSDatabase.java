    ...
    if (!localFileExists(cclass, sign, false)) {
      String message =
          "No TCRS data is available for "
              ...
              + "/"
              + sign
              + ". Would you like to derive it? (This will take a long time, but you only have to"
              + " do it once.)";
    ...
    if (!localCafeFileExists(cclass, sign, false)) {
      String message =
          "No TCRS cafe data is available for "
              ...
              + "/"
              + sign
              + ". Would you like to derive it? (This will not take long, and you only have to do"
              + " it once.)";
