...
public class WardrobeOMaticDatabase {
  ...
  public record FuturisticClothing(String name, String image, Map<DoubleModifier, Integer> modifiers){}

  private static final List<String> shirtAdjectives = List.of(
    "galvanized",
    "double-creased",
    "double-breasted",
    "foil-clad",
  ...
  private static final List<String> shirtMaterials = List.of(
    "gabardine",
    "mylar",
    "polyester",
    "double-polyester",
  ...
  private static final List<String> shirtQualities = List.of(
    "super", "hyper", "ultra", "mega", "reroll"
  );

  private static final List<String> shirts = List.of(
    "t-shirt",
    "sweater",
    "jersey",
    "polo shirt",
  ...
  public static FuturisticClothing shirt(int day, int tier) {
    ...
    var shirtModifiers = new ArrayList<>(List.of(MUS, MYS, MOX, HOT_RESISTANCE, COLD_RESISTANCE, STENCH_RESISTANCE, SLEAZE_RESISTANCE, SPOOKY_RESISTANCE, HP, MP, HP_REGEN_MIN, MP_REGEN_MIN, DAMAGE_REDUCTION, DAMAGE_ABSORPTION));
    if (tier > 3) {
    ...
    return new FuturisticClothing(adjective + " " + quality + material + " " + shirt, "jw_shirt" + imageNum + ".gif", modMap);
  }

  private static final List<String> hatAdjectives = List.of(
    "nanoplated",
    "self-replicating",
    "autonomous",
    "fusion-powered",
  ...
  private static final List<String> hatMaterials = List.of(
    "tungsten",
    "carbon",
    "steel",
    "aluminum",
  ...
  private static final List<String> hatEmphasis = List.of(
    "super",
    "ultra",
    "mega",
    "double-",
  ...
  private static final List<String> hats = List.of(
    "beanie",
    "fedora",
    "trilby",
    "beret",
  ...
  public static FuturisticClothing hat(int day, int tier) {
    ...
    var hatModifiers = new ArrayList<>(List.of(MUS, MYS, MOX, HP, MP, HP_REGEN_MIN, MP_REGEN_MIN, HOT_DAMAGE, COLD_DAMAGE, STENCH_DAMAGE, SLEAZE_DAMAGE, SPOOKY_DAMAGE, HOT_SPELL_DAMAGE, COLD_SPELL_DAMAGE, STENCH_SPELL_DAMAGE, SLEAZE_SPELL_DAMAGE, SPOOKY_SPELL_DAMAGE));
    if (tier > 3) {
    ...
    return new FuturisticClothing(adjective + " " + mat1 + "-" + mat2 + " " + emphasis + hat, "jw_hat" + imageNum + ".gif", modMap);
  }

  private static final List<String> collars = List.of("pet tag", "collar", "pet sweater");

  private static final List<String> collarAdjectives = List.of(
    "hyperchromatic",
    "pearlescent",
    "bright",
    "day-glo",
  ...
  private static final List<String> collarColors = List.of(
    "amber",
    "aquamarine",
    "auburn",
    "azure",
  ...
  public static FuturisticClothing collar(int day, int tier) {
    ...
    return new FuturisticClothing(adjective + " " + color1 + and + color2 + " " + collars.get((imageNum - 1) / 3), "jw_pet" + imageNum + ".gif", modMap);
  }
  ...
  private static int modStrength(PHPMTRandom mtRand, DoubleModifier mod, int level) {
    return switch (mod) {
      ...
      case HOT_RESISTANCE, COLD_RESISTANCE, STENCH_RESISTANCE, SPOOKY_RESISTANCE, SLEAZE_RESISTANCE -> mtRand.nextInt(level + 1, level + 3);
      ...
      case HOT_DAMAGE, COLD_DAMAGE, STENCH_DAMAGE, SPOOKY_DAMAGE, SLEAZE_DAMAGE, HOT_SPELL_DAMAGE, COLD_SPELL_DAMAGE, STENCH_SPELL_DAMAGE, SPOOKY_SPELL_DAMAGE, SLEAZE_SPELL_DAMAGE -> mtRand.nextInt(4 * level + 4, 6 * level + 6);
