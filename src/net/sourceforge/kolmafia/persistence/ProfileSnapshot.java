...
public class ProfileSnapshot {
  ...
  public static final String getStandardData(final boolean localProfileLink) {
    ...
    strbuf.append(
        "<center><br><br><table class=\"sortable\" id=\"overview\" border=0 cellspacing=0"
            + " cellpadding=10>");
    strbuf.append(KoLConstants.LINE_BREAK);
  ...
  private static String getOverviewHeader() {
    return "<td>Path</td><td align=center>Class</td><td align=center>Lvl</td><td"
               + " align=center>Turns</td><td align=center>Ascended</td><td align=center>Logged"
               + " In</td>";
  }
  ...
  private static String getStatsHeader() {
    return "<td align=center>Path</td><td align=center>Class</td><td"
               + " align=center>Lv</td><td>PvP</td><td align=center>Mus</td><td"
               + " align=center>Mys</td><td align=center>Mox</td><td align=center>Total"
               + " Turns</td><td align=center>Asc</td>";
  }
