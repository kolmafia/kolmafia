...
public class AscensionSnapshot {
  ...
  public static final String getAscensionData(
    ...
    strbuf.append(
        "Ascensions</b></td></tr><tr><td style=\"padding: 5px; border: 1px solid"
            + " blue;\"><center><table>");
    strbuf.append(KoLConstants.LINE_BREAK);
  ...
  public static final String getPathedAscensionData(
    ...
    switch (pathFilter) {
      ...
      case AscensionSnapshot.AVATAR_OF_WEST_OF_LOATHING:
        strbuf.append(
            "<br><a class=small href=\"javascript:void(0);\" onClick=\"javascript: var element ="
                + " document.getElementById('sec");
        strbuf.append(pathFilter);
        strbuf.append(
            "'); element.style.display = element.style.display == 'inline' ? 'none' :"
                + " 'inline';\">");
