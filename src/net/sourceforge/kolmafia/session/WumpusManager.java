  ...
  public static String reconstructResponseText(
    ...
    if (sounds != null) {
      ...
      if (sounds.contains("bats")) {
        buffer.append(
            "You hear the fluttering of wings and a high-pitched squeaking coming from somewhere"
                + " nearby.\n");
      }
      if (sounds.contains("Wumpus")) {
        buffer.append(
            "Spatters of blood covering the floor and an overpowering stench indicate that the"
                + " Wumpus must be nearby.\n");
      }
    }
