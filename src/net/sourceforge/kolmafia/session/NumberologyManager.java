...
public class NumberologyManager {
  ...
  public static final int rawNumberology(
      final int seed, final int adventureDelta, final int spleenDelta) {
    ...
    return (Math.abs(seed) + ascensions + sign) * (spleen + spleenDelta + level)
        + (adventures - adventureDelta);
  }
  ...
  public static final int numberology(
      final int seed, final int adventureDelta, final int spleenDelta) {
  ...
  public static final Map<Integer, Integer> reverseNumberology(
      final int adventureDelta, final int spleenDelta) {
