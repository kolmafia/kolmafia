...
public class BuffRequestFrame extends GenericFrame {
  private static final String NO_REQUEST_TEXT =
      "\n"
          ...
          + "At the frequent request of individuals wanting to see the name 'BOT_NAME' listed in"
          + " KoLmafia's buff purchase interface, BOT_NAME has been added to our internal buffbot"
          + " database.\n\n"
          + "However, at the request of the individuals responsible for maintaining BOT_NAME,"
          + " BOT_NAME's formal price list and buff offerings are not available directly through"
          + " KoLmafia.\n\n"
          + "You are welcome to use this interface to check whether or not BOT_NAME is currently"
          + " logged in to KoL.  However, we hope this message helps you understand why additional"
