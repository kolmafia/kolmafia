...
public class MonsterDescriptionFrame extends DescriptionFrame {
  ...
  public JToolBar createMonsterToolbar() {
    ...
    this.lastVariantButton =
        new ThreadedButton(JComponentUtilities.getImage("back.gif"), new LastVariantRunnable());
    ...
    this.nextVariantButton =
        new ThreadedButton(JComponentUtilities.getImage("forward.gif"), new NextVariantRunnable());
