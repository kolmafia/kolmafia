    ...
    public SimpleDeedConstructor() {
      ...
      this.setLabels(
          ...
          new String[] {
            ...
            "<html>Provide an integer to disable the button at.<br>The button will be enabled until"
                + " the preference reaches this number.</html>",
    ...
    public ItemDeedConstructor() {
      ...
      this.setLabels(
          ...
          new String[] {
            "The text to display on the button.",
            "The preference that the button will track.",
            "<html>If an item is not specified, defaults to displayText.  Uses fuzzy"
                + " matching.<br>Can add arbitrary GCLI commands by following the item name with a"
                + " semi-colon.</html>",
            "<html>Provide an integer to disable the button at.<br>The button will be enabled until"
                + " the preference reaches this number.</html>",
            "The tooltip when moused over.",
