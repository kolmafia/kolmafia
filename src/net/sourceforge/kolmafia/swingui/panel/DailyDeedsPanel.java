...
public class DailyDeedsPanel extends Box implements Listener {
  ...
  public static final String[][] BUILTIN_DEEDS = {
    {
      ...
      "breakfast",
      "1",
      "Perform typical daily tasks - use 1/day items, visit 1/day locations like various clan"
          + " furniture, use item creation skills, etc. Configurable in preferences.",
    ...
    },
    {
      ...
      "Rage Gland",
      "1",
      "-10% Mus/Myst/Mox, randomly chosen, and each turn of combat do level to 2*level damage, 5"
          + " turns",
      "Rage Gland used"
    },
    {
  ...
  private void parseComboDeed(String[] deedsString) {
    ...
    if (deedsString.length > (isMulti ? 4 : 3)
      ...
      RequestLogger.printLine(
          "Daily Deeds error: You did not pass the proper number of parameters for a deed of type"
              + " Combo.");
      return;
    }
    /*
