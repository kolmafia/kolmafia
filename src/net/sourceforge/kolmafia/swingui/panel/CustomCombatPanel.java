  ...
  private class SpecialActionsPanel extends GenericPanel implements Listener {
    ...
    public SpecialActionsPanel() {
      ...
      this.potionLabel =
          this.label(
              ...
              "<html>Dungeons of Doom potions will be identified by using them in"
                  + " combat.<br>Requires 'special' action if a CCS is used.</html>");
      ...
      this.safeLabel =
          this.label(
              ...
              "Pickpocketing will be skipped when there are no useful results or it is too"
                  + " dangerous.");
    ...
    public void update() {
      ...
      this.puttyLabel.setToolTipText(
          "<html>Automatic Spooky Putty sheet, Rain-Doh black box, 4-d camera, crappy camera or"
              + " portable photocopier use: "
              + text
              + "<br>Requires 'special' action if a CCS is used.</html>");
        ...
        if (source == SpecialActionsPanel.this.stealItem) {
          ...
          String option =
              !state
                  ...
                  : InputFieldUtilities.input(
                      "Use Transcendent Olfaction or odor extractor when? (item, \"goals\", or"
                          + " \"monster\" plus name; add \"abort\" to stop adventuring)",
                      "goals");
          ...
          String option =
              !state
                  ? null
                  : InputFieldUtilities.input(
                      "Use Spooky Putty sheet, Rain-Doh black box, 4-d camera, crappy camera or"
                          + " portable photocopier when? (item, \"goals\", or \"monster\" plus"
                          + " name; add \"abort\" to stop adventuring)",
                      "goals abort");
