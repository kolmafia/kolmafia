...
/**
 * An internal class which displays KoLmafia's current version information. This is passed to the
 * constructor for the <code>LicenseDisplay</code>.
 */
public class VersionDataPanel extends JPanel {
