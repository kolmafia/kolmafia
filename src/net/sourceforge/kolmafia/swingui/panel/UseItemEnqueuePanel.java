    ...
    protected void execute() {
      ...
      if (warnFirst
          && !InputFieldUtilities.confirm(
              "This action will also consume any queued items.  Are you sure you wish to"
                  + " continue?")) {
        return;
      }
  ...
  private abstract class FamiliarFeedListener extends ThreadedListener {
    ...
    protected void execute() {
      if (this.warnBeforeConsume()
          && !InputFieldUtilities.confirm(
              "This action will also feed any queued items to your familiar. Are you sure you wish"
                  + " to continue?")) {
        return;
      }
