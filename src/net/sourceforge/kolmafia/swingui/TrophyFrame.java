...
public class TrophyFrame extends GenericFrame {
  ...
  public static class TrophyArrangePanel extends JPanel {
    ...
    public TrophyArrangePanel() {
      ...
      eastPanel.add(
          new JLabel(
              "<html><center>top list:<br>visible<hr>bottom:<br>hidden<br><br>drag"
                  + " to<br>rearrange<br><br>trophies<br>exchange<br>positions<br>if"
                  + " dropped<br>directly<br>on top of<br>another,<br>otherwise<br>moved.</html>"),
          BorderLayout.SOUTH);
