...
public class PartialMRUList extends ScriptMRUList implements Listener {
   ...
   * environments, it is typed as an Object
   */
  ...
  /**
   * Adapted from <a
   * href="http://www.jroller.com/santhosh/entry/jcombobox_items_with_separators">.</a> Last Access:
  ...
  abstract static class ComboSeparatorsRenderer implements ListCellRenderer<Object> {
    ...
    public Component getListCellRendererComponent(
      ...
      if (index != -1
          && addSeparatorAfter(
              list, value, index)) { // index==1 if renderer is used to paint current value in combo
