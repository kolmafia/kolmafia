...
public class KoLAdventure implements Comparable<KoLAdventure>, Runnable {
  ...
  private static boolean getEnchantedBean() {
    ...
    if (StaticEntity.isGUIRequired()
        ...
        && !InputFieldUtilities.confirm(
            "KoLmafia thinks you haven't planted an enchanted bean yet.	Would you like to have"
                + " KoLmafia automatically adventure to obtain one?")) {
      return false;
    }
  ...
  private static final Object[][] ADVENTURE_FAILURES = {
    ...
    // Lots of places.
    {
      ...
      "Your stats are too low for this location.  Adventure manually to acknowledge or disable this"
          + " warning.",
    },
