...
public class NaiveSecureSocketLayer {
  ...
  static {
    try {
      NaiveSecureSocketLayer.DEFAULT_SOCKET_FACTORY =
          HttpsURLConnection.getDefaultSSLSocketFactory();
      NaiveSecureSocketLayer.DEFAULT_HOSTNAME_VERIFIER =
    ...
    try {
      TrustManager[] naiveTrustManagers = new TrustManager[] {new NaiveTrustManager()};
