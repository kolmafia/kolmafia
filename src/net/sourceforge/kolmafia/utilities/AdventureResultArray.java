 ...
 * a list. This could be done with generics (Java 1.5) but is done like this so that we get
 * backwards compatibility.
 */
public class AdventureResultArray implements Iterable<AdventureResult> {
