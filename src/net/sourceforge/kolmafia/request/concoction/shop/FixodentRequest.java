...
public class FixodentRequest extends CreateItemRequest {
  public FixodentRequest(final Concoction conc) {
    ...
    this.addFormField("whichshop", "fixodent");
  ...
  public void processResults() {
    ...
    if (urlString.contains("action=buyitem") && !responseText.contains("You acquire")) {
      KoLmafia.updateDisplay(MafiaState.ERROR, "Crafting with Teeth was unsuccessful.");
      return;
    }

    FixodentRequest.parseResponse(urlString, responseText);
  }
