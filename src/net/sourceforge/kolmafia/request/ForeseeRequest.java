...
public class PeridotRequest extends GenericRequest {

  public PeridotRequest() {
    super("inventory.php?action=foresee", false);
    this.monster = null;
  }

  public PeridotRequest(final MonsterData monster) {
    super("choice.php");
