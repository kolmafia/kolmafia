...
public class SkateParkRequest extends GenericRequest {
  ...
  public static final Object[][] BUFF_DATA = {
    ...
    },
    {
      ...
      "comet, the roller skate",
      "state3buff1",
        (Integer) SkateParkRequest.COMET,
      "_skateBuff2",
    ...
    },
    {
      ...
      "the band shell",
      "state4buff1",
        (Integer) SkateParkRequest.BAND_SHELL,
      "_skateBuff3",
    ...
    },
    {
      ...
      "the eclectic eels",
      "state4buff2",
        (Integer) SkateParkRequest.ECLECTIC_EELS,
      "_skateBuff4",
    ...
    },
    {
      ...
      "the merry-go-round",
      "state4buff3",
        (Integer) SkateParkRequest.MERRY_GO_ROUND,
      "_skateBuff5",
      "Wait until tomorrow",
      "peace",
    },
