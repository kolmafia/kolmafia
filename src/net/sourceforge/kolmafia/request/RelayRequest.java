...
public class RelayRequest extends PasswordHashRequest {
        ...
        if (linkIndex != -1) {
          responseBuffer.insert(
              ...
              "<a href=\""
                  ...
                  + "\"><b>KoLmafia gCLI</b></a></center><p>Type KoLmafia scripting commands in"
                  + " your browser!</p><center>");
        }
      }
  ...
  private boolean sendBreakPrismWarning(final String urlString) {
    ...
    if (KoLCharacter.isKingdomOfExploathing()) {
      ...
      String warning =
          "You are about to free King Ralph and end your Kingdom of Exploathing run. Before you do"
              + " so, you might want to redeem your rare Meat isotopes at Cosmic Ray's Bazaar,"
              + " since you will not be able to do so after you free the king. If you are ready to"
              + " break the prism, click on the icon on the left. If you wish to visit Cosmic Ray's"
              + " Bazaar, click on icon on the right.";
  ...
  private boolean sendCoinMasterWarning(final CoinmasterData camp) {
    ...
    message =
        message
            + " Before you do so, you might want to redeem war loot for dimes and quarters and buy"
            + " equipment. Click on the image to enter battle, once you are ready.";
  ...
  private boolean sendInfernalSealWarning(final String urlString) {
    ...
    message =
        "You are trying to summon an infernal seal, but you are not wielding a club. You are either"
            + " incredibly puissant or incredibly foolish. If you are sure you want to do this,"
            + " click on the image and proceed to your doom.";
  ...
  private boolean sendGremlinWarning(final KoLAdventure adventure) {
    ...
    message =
        "You are about to fight Gremlins, but do not have the Molybdenum Magnet. If you are sure"
            + " you want to do this, click on the image to proceed.";
  ...
  private boolean sendHardcorePVPWarning(final String urlString) {
    ...
    message =
        "You have fights remaining and are still in Hardcore. If you are sure you don't want to use"
            + " the fights in hardcore, click on the image to proceed.";
  ...
  private boolean sendDesertOffhandWarning() {
    ...
    if (InventoryManager.getCount(ItemPool.DOWSING_ROD) > 0) {
      ...
      String warning =
          "You are about to adventure without your ornate dowsing rod in the desert. If you are"
              + " sure you wish to adventure without it, click the icon on the left to adventure."
    ...
    // If you have UV Compass, suggest it
      ...
      String warning =
          "You are about to adventure without your UV-resistant compass in the desert. If you are"
              + " sure you wish to adventure without it, click the icon on the left to adventure."
    ...
    // Otherwise just ask if you want to adventure
      ...
      String message =
          "You are about to adventure without a UV-resistant compass in the desert. If you are sure"
              + " you want to do this, click on the image to proceed.";
  ...
  private boolean sendUnhydratedDesertWarning() {
    ...
    String warning =
        "You are about to adventure unhydrated in the desert. If you are sure you wish to adventure"
            + " unhydrated, click the icon on the left to adventure. If you want to visit the Oasis"
            + " to get ultrahydrated, click the icon on the right to adventure. ";
    this.sendOptionalWarning(
  ...
  private boolean sendMacheteWarning() {
    ...
    if (InventoryManager.getCount(ItemPool.PAPIER_MACHETE) > 0) {
      ...
      String warning =
          "You are about to adventure without your papier-m&acirc;ch&eacute;te to fight dense"
              + " lianas. If you are sure you wish to adventure without it, click the icon on the"
              + " left to adventure. If you want to equip the papier-m&acirc;ch&eacute;te first,"
    ...
    // If you have muculent machete, suggest it
      ...
      String warning =
          "You are about to adventure without your muculent machete to fight dense lianas. If you"
              + " are sure you wish to adventure without it, click the icon on the left to"
              + " adventure. If you want to equip the muculent machete first, click the icon on the"
              + " right. ";
      this.sendOptionalWarning(
          CONFIRM_MACHETE,
          warning,
    ...
    // If you have machetito, suggest it
      ...
      String warning =
          "You are about to adventure without your machetito to fight dense lianas. If you are sure"
              + " you wish to adventure without it, click the icon on the left to adventure. If you"
              + " want to equip the machetito first, click the icon on the right. ";
      this.sendOptionalWarning(
          CONFIRM_MACHETE,
          warning,
          "hand.gif",
    ...
    // If you have antique machete, suggest it
      ...
      String warning =
          "You are about to adventure without your antique machete to fight dense lianas. If you"
              + " are sure you wish to adventure without it, click the icon on the left to"
              + " adventure. If you want to equip the antique machete first, click the icon on the"
              + " right. ";
      this.sendOptionalWarning(
          CONFIRM_MACHETE,
          warning,
    ...
    // Otherwise just ask if you want to adventure
      ...
      String message =
          "You are about to adventure without a machete to fight dense lianas. If you are sure you"
              + " want to do this, click on the image to proceed.";
  ...
  private boolean sendMohawkWigWarning() {
    ...
    String warning =
        "You are about to adventure without your Mohawk Wig in the Castle. If you are sure you wish"
            + " to adventure without it, click the icon on the left to adventure. If you want to"
            + " put the hat on first, click the icon on the right. ";
    this.sendOptionalWarning(
        CONFIRM_MOHAWK_WIG,
        warning,
        "hand.gif",
  ...
  private boolean sendBoringDoorsWarning() {
    ...
    String warning =
        "You are about to adventure without your Ring of Detect Boring Doors in the "
            + nextChamber
            + "th Chamber of the Daily Dungeon. If you are sure you wish to adventure without it,"
            + " click the icon on the left to adventure. If you want to put the ring on first,"
            + " click the icon on the right. ";
    this.sendOptionalWarning(
  ...
  private boolean sendPoolSkillWarning() {
    ...
    if (!KoLCharacter.canDrink()) {
      ...
      if (image2 == null) {
        warning.append(
            "<br>If you are sure you wish to adventure at this drunkenness, click the icon to"
                + " adventure. ");
      } else {
        warning.append(
            "<br>If you are sure you wish to adventure at this drunkenness, click the icon on the"
                + " left to adventure. ");
      }
    }
    ...
    if (image3 == null) {
      if ("poolcue.gif".equals(image2)) {
        warning.append(
            "<br>If you want to wield the cue first, for an extra three skill, click the icon on"
                + " the right. ");
      } else if ("poolcuef.gif".equals(image2)) {
        warning.append(
            "<br>If you want to wield the Staff of Fats first, for an extra five skill, click the"
                + " icon on the right. ");
        image2 = "poolcue.gif";
      } else if ("staffofed.gif".equals(image2)) {
        warning.append(
            "<br>If you want to wield the Staff of Ed first, for an extra five skill, click the"
                + " icon on the right. ");
      } else if ("disease.gif".equals(image2)) {
        warning.append(
            "<br>If you want to use hand chalk first, for an extra three skill, click the icon on"
                + " the right. ");
      }
    } else if ("disease.gif".equals(image3)) {
      warning.append(
          "<br>If you want to wield the cue first, for an extra three skill, click the icon in the"
              + " middle. ");
      warning.append(
          "<br>If you want to use hand chalk first, for an extra three skill, click the icon in the"
              + " right. ");
    }
  ...
  private boolean sendCellarWarning() {
    ...
    message =
        "You are about to adventure without reading the Mortar dissolving recipe with glasses"
            + " equipped.  If you are sure you want to do this, click on the image to proceed.";
  ...
  private boolean sendZeppelinWarning() {
    ...
    String warning =
        "You are about to adventure in the Red Zeppelin, but do not have a Zeppelin Ticket. If you"
            + " are sure you wish to adventure without it, click the icon on the left to adventure."
  ...
  private boolean sendBoilerWarning() {
    ...
    message =
        "You are about to adventure in the Haunted Boiler Room, but do not have Unstable Fulminate"
            + " equipped. If you are sure you want to do this, click on the image to proceed.";
  ...
  private boolean sendDiaryWarning() {
    ...
    message =
        "You are about to adventure but have not obtained your father's MacGuffin diary. If you are"
            + " sure you want to do this, click on the image to proceed.";
  ...
  private boolean sendWossnameWarning(final CoinmasterData camp) {
    ...
    String message =
        "You are about to defeat the last "
            ...
            + side2
            + ". If you are sure you don't want the Order of the Silver Wossname, click on the"
            + " image and proceed.";
  ...
  private boolean sendFamiliarWarning() {
    ...
    warning.append(
        "<body><center><table width=95%	 cellspacing=0 cellpadding=0><tr><td style=\"color:"
            + " white;\" align=center bgcolor=blue><b>Results:</b></td></tr><tr><td"
            + " style=\"padding: 5px; border: 1px solid blue;\"><center><table><tr><td><center>");
    ...
    warning.append(
        "<td align=center valign=center><div id=\"lucky\" style=\"padding: 4px 4px 4px 4px\"><a"
    ...
    warning.append(
        "<a style=\"text-decoration: none\" href=\"#\" onClick=\"singleUse('familiar.php',"
            + " 'action=newfam&ajax=1&newfam=");
    ...
    warning.append(
        "</tr></table></center><blockquote>KoLmafia has detected that you may be doing a 100%"
            + " familiar run.  If you are sure you wish to deviate from this path, click on the"
            + " familiar on the left.  If this was an accident, please click on the familiar on the"
            + " right to switch to your 100% familiar.");
    warning.append(
  ...
  private boolean sendKungFuWarning() {
    ...
    warning.append(
        "<a style=\"text-decoration: none\""
            + " href=\"/KoLmafia/redirectedCommand?cmd=unequip+weapon;unequip+offhand&pwd=");
    ...
    warning.append(
        "</tr></table></center><blockquote>KoLmafia has detected that you are about to lose Kung Fu"
            + " buffs.  ");
    warning.append(
        "If you are sure you wish to lose these buffs, click the icon on the left to adventure.  If"
  ...
  private boolean sendBossWarning(
    ...
    warning.append("} ");
    warning.append(
        "getObject(\"mcd1\").style.border = (current == default1) ? \"1px dashed blue\" : \"1px"
            + " dashed white\"; ");
    warning.append(
        "getObject(\"mcd2\").style.border = (current == default2) ? \"1px dashed blue\" : \"1px"
            + " dashed white\"; ");
    warning.append(
    ...
    warning.append(
        "<tr align=center><td><a id=\"link1\" style=\"text-decoration: none\""
            + " onClick=\"switchLinks('mcd1'); void(0);\" href=\"#\"><img"
            + " src=\"/images/itemimages/");
    ...
    warning.append("<table ncol=1 width=100>");
    warning.append(
        "<tr align=center><td><a id=\"link2\" style=\"text-decoration: none\""
            + " onClick=\"switchLinks('mcd2'); void(0);\" href=\"#\"><img"
            + " src=\"/images/itemimages/");
    ...
    warning.append(
        " drops special rewards based on your mind-control level.  If you'd like a special reward,"
            + " click on one of the items above to set your mind-control device appropriately. "
            + " Click on it again to reset the MCD back to your old setting.	 Click on ");
    warning.append(name);

    warning.append(
        " once you've decided to"
            + " proceed.</blockquote></td></tr></table></center></td></tr></table></center></body></html>");
  ...
  private boolean sendArcadeWarning() {
    ...
    if (power <= 50
      ...
      this.sendGeneralWarning(
          "ggtoken.gif",
          "You might not be properly equipped to play this game.<br>Click the token if you'd like"
              + " to continue anyway.",
          CONFIRM_ARCADE);
      return true;
    }
  ...
  private boolean sendWineglassWarning(final KoLAdventure adventure) {
    ...
    String warning =
        "KoLmafia has detected that you are about to adventure while overdrunk. If you are sure you"
            + " wish to adventure in a Drunken Stupor, click the icon on the left to adventure. If"
            + " this was an accident, click the icon in the center to equip Drunkula's wineglass."
            + " If you want to adventure in a Drunken Stupor and not be nagged, click the icon on"
            + " the right to closet Drunkula's wineglass.";
    this.sendOptionalWarning(
        CONFIRM_WINEGLASS,
        warning,
        "hand.gif",
  ...
  private boolean sendOverdrunkAdventureWarning(final KoLAdventure adventure) {
    ...
    String warning =
        "KoLmafia has detected that you are about to adventure while overdrunk. If you are sure you"
            + " wish to adventure in a Drunken Stupor, click the icon to adventure. ";
  ...
  public void sendGeneralWarning(
    ...
    warning.append(
        "<html><head><link rel=\"stylesheet\" type=\"text/css\" href=\"/images/styles.css\"><script"
            + " language=\"Javascript\" src=\"/");
    warning.append(KoLConstants.BASICS_JS);
    warning.append(
        "\"></script></head><body><center><table width=95%  cellspacing=0 cellpadding=0><tr><td"
            + " style=\"color: white;\" align=center bgcolor=blue><b>Results:</b></td></tr><tr><td"
  ...
  public void sendOptionalWarning(
    ...
    if (image1 != null && !image1.equals("")) {
      ...
      warning.append(
          "<td align=center valign=center><div id=\"proceed\" style=\"padding: 4px 4px 4px 4px\"><a"
              + " style=\"text-decoration: none\" href=\"");
      warning.append(url);
      warning.append(!url.contains("?") ? "?" : "&");
      warning.append(confirm);
    ...
    if (image2 != null && !image2.equals("")) {
      ...
      warning.append(
          "<td align=center valign=center><div id=\"optionalAction1\" style=\"padding: 4px 4px 4px"
              + " 4px\">");
    ...
    if (image3 != null && !image3.equals("")) {
      ...
      // perform optional action, do not (yet) adventure.
      warning.append(
          "<td align=center valign=center><div id=\"optionalAction2\" style=\"padding: 4px 4px 4px"
              + " 4px\">");
      warning.append("<a style=\"text-decoration: none\" href=");
  ...
  public boolean sendCloverWarning(final String adventureName) {
    ...
    if (closetClovers) {
      ...
      warning.append(
          "<a style=\"text-decoration: none\" href=\"#\" onClick=\"inlineLoad('fillcloset.php',"
              + " 'action=closetpush&whichitem=");
    ...
    warning.append(
        "</tr></table></center><blockquote>KoLmafia has detected a ten-leaf clover in your"
            + " inventory.  If you are sure you wish to use it, click on the assembled clover on"
            + " the left.  If this was an accident, please click on the ");
    if (closetClovers) {
    ...
    warning.append(
        " your clovers first.  To disable this warning, please check your preferences and disable"
            + " clover"
            + " protection.</blockquote></td></tr></table></center></td></tr></table></center></body></html>");
  ...
  private boolean sendCounterWarning() {
    ...
    while (expired != null) {
      ...
      switch (remain) {
        ...
        case 1:
          msg.append(
              " counter will expire after 1 more turn, so you may wish to adventure somewhere else"
                  + " that takes 1 turn.");
          break;
        default:
    ...
    if (msg != null) {
      ...
      if (voteMonster && !KoLCharacter.hasEquipped(ItemPool.I_VOTED_STICKER)) {
        msg.append(
            "You do not have the \"I voted\" sticker equipped, to continue without, click the icon"
                + " on the left to adventure. ");
