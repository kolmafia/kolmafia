...
public class DwarfContraptionRequest extends GenericRequest {
  public static final Pattern GAUGES_PATTERN =
      Pattern.compile("temp0=(\\d*)&temp1=(\\d*)&temp2=(\\d*)&temp3=(\\d*)");
  public static final Pattern HOPPER_PATTERN =
      Pattern.compile("action=dohopper(\\d*).*howmany=(\\d*).*whichore=([^&]*)");
  public static final Pattern CHAMBER_PATTERN =
      Pattern.compile("howmany=(\\d*).*whichitem=([^&]*)");
  ...
  public static final void parseResponse(final String urlString, final String responseText) {
    ...
    if (action.startsWith("dohopper")) {
      ...
      AdventureResult ore =
          ItemPool.get(DwarfContraptionRequest.oreName(hopperMatcher.group(3)), -count);
