...
public class ArtistRequest extends PlaceRequest {
  ...
  public static final void parseResponse(final String location, final String responseText) {
    ...
    if (location.contains("subaction=whiskers") && responseText.contains("Thanks, Adventurer.")) {
