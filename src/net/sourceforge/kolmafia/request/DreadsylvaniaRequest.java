...
public class DreadsylvaniaRequest extends GenericRequest {
  ...
  public static final String[][] SHORTCUTS =
      new String[][] {
        {
          "The Cabin", "Dreadsylvanian Woods", "shortcut1.gif", "ghostPencil1",
        },
        {
          "The Tallest Tree", "Dreadsylvanian Woods", "shortcut2.gif", "ghostPencil2",
        },
        {
          "The Burrows", "Dreadsylvanian Woods", "shortcut3.gif", "ghostPencil3",
        },
        {
          "The Village Square", "Dreadsylvanian Village", "shortcut4.gif", "ghostPencil4",
        },
        {
          "Skid Row", "Dreadsylvanian Village", "shortcut5.gif", "ghostPencil5",
        },
        {
          "The Old Duke's Estate", "Dreadsylvanian Village", "shortcut6.gif", "ghostPencil6",
        },
        {
          "The Great Hall", "Dreadsylvanian Castle", "shortcut7.gif", "ghostPencil7",
        },
        {
          "The Tower", "Dreadsylvanian Castle", "shortcut8.gif", "ghostPencil8",
        },
        {
          "The Dungeons", "Dreadsylvanian Castle", "shortcut9.gif", "ghostPencil9",
        },
      };
  ...
  public static final String shortcutIndexToName(int index) {
    return (index < 0 || index > DreadsylvaniaRequest.SHORTCUTS.length)
        ? null
        : DreadsylvaniaRequest.SHORTCUTS[index][0];
  }

  public static final String shortcutIndexToZone(int index) {
    return (index < 0 || index > DreadsylvaniaRequest.SHORTCUTS.length)
        ? null
        : DreadsylvaniaRequest.SHORTCUTS[index][1];
  }

  public static final String shortcutIndexToImage(int index) {
    return (index < 0 || index > DreadsylvaniaRequest.SHORTCUTS.length)
        ? null
        : DreadsylvaniaRequest.SHORTCUTS[index][2];
  }

  public static final String shortcutIndexToSetting(int index) {
    return (index < 0 || index > DreadsylvaniaRequest.SHORTCUTS.length)
        ? null
        : DreadsylvaniaRequest.SHORTCUTS[index][3];
  }
  ...
  private static final Pattern SHORTCUT_PATTERN =
      Pattern.compile("otherimages/dv/(shortcut.\\.gif)");
