    ...
    if (!won) {
      ...
      switch (familiar.getId()) {
        ...
        case FamiliarPool.COOKBOOKBAT:
          ...
          if (Preferences.getInteger("cookbookbatQuestTurns") >= 6
              && locationName != Preferences.getString("cookbookbatQuestLocation")
              && Preferences.getString("cookbookbatQuestLocation") != "") {
