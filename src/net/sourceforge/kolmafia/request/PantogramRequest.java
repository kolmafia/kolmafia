...
public class PantogramRequest extends GenericRequest {
  private static final Pattern urlPattern =
      Pattern.compile("m=(\\d)&e=(\\d)&s1=(.*)?&s2=(.*)?&s3=(.*)");
  ...
  public static final void parseResponse(final String urlString, final String responseText) {
    ...
    if (matcher.find()) {
      ...
      ModifierDatabase.overrideModifier(ModifierType.ITEM, ItemPool.PANTOGRAM_PANTS, modList.toString());
