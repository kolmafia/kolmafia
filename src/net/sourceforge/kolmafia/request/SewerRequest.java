	...
	extends CreateItemRequest
{
	...
	public static boolean retrieveSewerItems( final AdventureResult item, final boolean canUseCloset, final boolean canUseStorage )
	{
		...
		if ( count < needed )
		{
			KoLmafia.updateDisplay( MafiaState.ABORT, "Unable to acquire " + ( needed - count ) + " sewer items." );
		}
	...
	private static void transferSewerItems( final AdventureResult[] transfers,
