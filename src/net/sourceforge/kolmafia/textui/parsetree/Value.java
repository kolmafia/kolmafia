...
public class Value implements TypedNode, Comparable<Value> {
  ...
  public Value toFloatValue() {
    if (this.getType().equals(TypeSpec.TYPE_FLOAT)) {
      return this;
    }
  ...
  public Value toIntValue() {
    if (this.getType().equals(TypeSpec.TYPE_INT)) {
      return this;
    }
    if (this.getType().equals(TypeSpec.TYPE_BOOLEAN)) {
  ...
  public Value asProxy() {
    return switch (this.getType().getType()) {
      case TYPE_CLASS -> new ProxyRecordValue.ClassProxy(this);
      case TYPE_ITEM -> new ProxyRecordValue.ItemProxy(this);
      case TYPE_FAMILIAR -> new ProxyRecordValue.FamiliarProxy(this);
      case TYPE_SKILL -> new ProxyRecordValue.SkillProxy(this);
      case TYPE_EFFECT -> new ProxyRecordValue.EffectProxy(this);
      case TYPE_LOCATION -> new ProxyRecordValue.LocationProxy(this);
      case TYPE_MONSTER -> new ProxyRecordValue.MonsterProxy(this);
      case TYPE_COINMASTER -> new ProxyRecordValue.CoinmasterProxy(this);
      case TYPE_BOUNTY -> new ProxyRecordValue.BountyProxy(this);
      case TYPE_THRALL -> new ProxyRecordValue.ThrallProxy(this);
      case TYPE_SERVANT -> new ProxyRecordValue.ServantProxy(this);
      case TYPE_VYKEA -> new ProxyRecordValue.VykeaProxy(this);
      case TYPE_PATH -> new ProxyRecordValue.PathProxy(this);
      case TYPE_ELEMENT -> new ProxyRecordValue.ElementProxy(this);
      case TYPE_PHYLUM -> new ProxyRecordValue.PhylumProxy(this);
      case TYPE_STAT -> new ProxyRecordValue.StatProxy(this);
      case TYPE_SLOT -> new ProxyRecordValue.SlotProxy(this);
      default -> this;
    };
  }
  ...
  public Object toJSON() throws JSONException {
    ...
    } else if (this.getType().equals(TypeSpec.TYPE_INT)) {
      return Long.valueOf(this.contentLong);
    } else if (this.getType().equals(TypeSpec.TYPE_FLOAT)) {
