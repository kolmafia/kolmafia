...
public class IncDec extends Evaluable {
  ...
  public String toString() {
    String operStr = oper.operator;
    return operStr == Parser.PRE_INCREMENT
        ? ("++" + this.lhs.getName())
        : operStr == Parser.PRE_DECREMENT
            ? ("--" + this.lhs.getName())
            : operStr == Parser.POST_INCREMENT
                ? (this.lhs.getName() + "++")
  ...
  public void print(final PrintStream stream, final int indent) {
    String operStr = oper.operator;
    String type =
        operStr == Parser.PRE_INCREMENT
            ? "PRE-INCREMENT"
            : operStr == Parser.PRE_DECREMENT
                ? "PRE-DECREMENT"
                : operStr == Parser.POST_INCREMENT
                    ? "POST-INCREMENT"
                    : operStr == Parser.POST_DECREMENT ? "POST-DECREMENT" : "UNKNOWN";
