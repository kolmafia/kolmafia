	...
	extends CompositeType
{
	...
	private AggregateType( final String name, final Type dataType, final Type indexType, final int size, final boolean caseInsensitive, final Location location )
	{
	...
	{
		this( "aggregate", original.dataType, original.indexType, original.size, original.caseInsensitive, location );
	}
	...
	private class AggregateTypeReference
