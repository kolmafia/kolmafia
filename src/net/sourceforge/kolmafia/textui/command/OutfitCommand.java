...
public class OutfitCommand extends AbstractCommand {
  public OutfitCommand() {
    this.usage =
        " [list <filter>] | save <name> | checkpoint | <name> - list, save, restore, or change outfits.";
  }
  ...
  public void run(final String cmd, final String parameters) {
    ...
    if (intendedOutfit != SpecialOutfit.PREVIOUS_OUTFIT
