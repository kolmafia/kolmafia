  ...
  public CargoCultCommand() {
    this.usage =
        "[?] # | monster MONSTER | effect EFFECT | item ITEM | stat STAT - pick pocket from your shorts"
            ...
            + KoLConstants.LINE_BREAK
            + "cargo count ( type TYPE | unpicked TYPE | monster MONSTER | effect EFFECT | item ITEM | stat STAT ) - count matching pockets"
            + KoLConstants.LINE_BREAK
            + "cargo list ( type TYPE | unpicked TYPE |monster MONSTER | effect EFFECT | item ITEM | stat STAT ) - list matching pockets"
            + KoLConstants.LINE_BREAK
  ...
  public void run(final String cmd, String parameters) {
    ...
    if (command.equals("count") || command.equals("list")) {
      String usage =
          "cargo "
              + command
              + " ( type TYPE | unpicked TYPE | monster MONSTER | item ITEM | effect EFFECT | stat STAT )";
      if (split.length < 3) {
