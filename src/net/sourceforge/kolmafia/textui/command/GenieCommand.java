...
public class GenieCommand extends AbstractCommand {
  public GenieCommand() {
    this.usage =
        " effect <effectname> | monster <monstername> | stat (mus|mys|mox|all) | meat | item"
            + " (pony|pocket|shirt) | wish <wish> | freedom";
  }
