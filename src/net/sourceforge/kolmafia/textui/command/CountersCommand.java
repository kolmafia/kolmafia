...
public class CountersCommand extends AbstractCommand {
  public CountersCommand() {
    this.usage =
        " [ clear | add <number> [<title> <img>] | stop <title> | warn <title> | nowarn <title> ] -"
            + " show, clear, or add to current turn counters, or set an existing counter to (not)"
            + " warn you when it expires.";
  }
