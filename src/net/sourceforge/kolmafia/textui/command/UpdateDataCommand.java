...
public class UpdateDataCommand extends AbstractCommand {
  public UpdateDataCommand() {
    this.usage =
        " clear | save | prices <URL or filename> - revert to built-in data or save override files"
            + " for new objects.";
  }
  ...
  public void run(final String cmd, final String parameters) {
    ...
    KoLmafia.updateDisplay(
        MafiaState.ABORT,
        "\"update\" doesn't do what you think it does.	Please visit kolmafia.us and download a"
            + " daily build if you'd like to keep KoLmafia up-to-date between major releases.");
  }
}
