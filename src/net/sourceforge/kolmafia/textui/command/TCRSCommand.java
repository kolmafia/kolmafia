...
public class TCRSCommand extends AbstractCommand {
  public TCRSCommand() {
    this.usage =
        " fetch CLASS, SIGN | load | save | derive [#] | check # | apply | help - handle item"
            + " modifiers for Two Crazy Random Summer.";
  }
  ...
  public void run(final String cmd, String parameters) {
    ...
    if (command.equals("help")) {
      ...
      RequestLogger.printLine(
          "test CLASS SIGN - load and apply data for class and sign, regardless of current path,"
              + " class, and sign.");
