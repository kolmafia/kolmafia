...
public class RefreshStatusCommand extends AbstractCommand {
  public RefreshStatusCommand() {
    this.usage =
        " all | [status | effects] | [gear | equip | outfit] | inv | camp | storage | [familiar | terarrium] | stickers | quests | shop - resynchronize with KoL.";
  }
  ...
  public void run(final String cmd, String parameters) {
    if (parameters.equals("all")) {
      ...
      GenericRequest request =
          KoLCharacter.inQuantum() ? new QuantumTerrariumRequest() : new FamiliarRequest();
