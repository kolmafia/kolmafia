...
public interface ScriptRuntime
{
	...
	{
		ScriptRuntime.traceStream.setStream( RequestLogger.openStream( "ASH_" + KoLConstants.DAILY_FORMAT.format( new Date() ) + ".txt", ScriptRuntime.traceStream.getStream(), true ) );
	}
	...
	Value execute( final String functionName, final Object[] parameters, final boolean executeTopLevel );
