...
public class Parser {
  ...
  private ParseTreeNode parseCommand(
  ...
  public final ScriptException sinceException(
    ...
    if (targetIsRevision) {
      template =
          "'%s' requires revision r%s of kolmafia or higher (current: r%s).  Up-to-date builds can"
              + " be found at https://ci.kolmafia.us/.";
    } else {
      template =
          "'%s' requires version %s of kolmafia or higher (current: %s).  Up-to-date builds can be"
              + " found at https://ci.kolmafia.us/.";
    }
  ...
  public static String undefinedFunctionMessage(final String name, final List<Value> params) {
    ...
    buffer.append(
        "' undefined.  This script may require a more recent version of KoLmafia and/or its"
            + " supporting scripts.");
