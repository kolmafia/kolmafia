...
public class MoodTrigger implements Comparable<MoodTrigger> {
  ...
  public String toSetting() {
    ...
    if (this.item != null) {
      return this.type
          ...
          + this.count
          + " "
          + StringUtilities.getCanonicalName(this.item.getDataName());
    }
    ...
    if (this.skill != null) {
      return this.type
          ...
          + this.count
          + " "
          + StringUtilities.getCanonicalName(this.skill.getSkillName());
    }
    ...
    if (this.skill != null) {
      ...
      if (!UseSkillRequest.lastUpdate.equals("")) {
        ...
        KoLmafia.updateDisplay(
            MafiaState.ERROR,
            "Mood failed to cast " + casts + " " + name + ": " + UseSkillRequest.lastUpdate);
  ...
  public boolean shouldExecute(final int multiplicity) {
    ...
    if (this.effect != null && EffectAvailability.cannotGain(this.effect.getEffectId())) {
      return false;
    }
