/**
 * @(#)MenuScroller.java	1.6.0 05/04/21
 */
...
public class MenuScroller {
        ...
        private final MouseWheelListener mouseWheelListener = new MenuMouseWheelListener();
        ...
        private class MenuMouseWheelListener implements MouseWheelListener {
                @Override
                public void mouseWheelMoved( MouseWheelEvent mouseWheelEvent )
                {
                        firstIndex += mouseWheelEvent.getWheelRotation();
                        refreshMenu();
                }
        }
        ...
        private static enum MenuIcon implements Icon {
                ...
                public void paintIcon(Component c, Graphics g, int x, int y) {
                        ...
                        g2.setColor( UIManager.getColor( "List[Disabled].textForeground" ) );
                        g2.drawPolygon(xPoints, yPoints, 3);
                        if (c.isEnabled()) {
                                g2.setColor( UIManager.getColor( "List.textForeground" ) );
