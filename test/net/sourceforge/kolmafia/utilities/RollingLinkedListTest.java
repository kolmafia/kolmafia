...
/**
 * As implemented RollingLinkedList will fail if passed an initial length that is negative.  addAll is not
 * implementd and so the list can be longer than the declared length.
 */
