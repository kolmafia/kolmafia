        ...
        new Object[][] {
          {
            ...
            new String[] {
              ...
              ("(none|food|drink|spleen|usable|multiple|reusable|message|grow|pokepill|"
                   + "hat|weapon|sixgun|offhand|container|shirt|pants|accessory|familiar|sticker|card|folder|bootspur|bootskin|food"
                   + " helper|drink"
                   + " helper|zap|sphere|guardian|avatar|potion)(\\s*,\\s*(usable|multiple|reusable|combat|combat"
                   + " reusable|single|"
