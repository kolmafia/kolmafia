...
class ManaBurnTest {
  ...
  public void durationShouldLimitCast() {
    ManaBurn testMe = new ManaBurn(3010, "Leash of Linguini", "Leash of Linguini", 100, 0);
    assertFalse(testMe.isCastable(10), "Duration exceeds limit.");
  }

  @Test
  public void manaShouldLimitCast() {
    ManaBurn testMe = new ManaBurn(3010, "Leash of Linguini", "Leash of Linguini", 0, 10);
  ...
  public void itCanSimulateCast() {
    ManaBurn testMe = new ManaBurn(3010, "Leash of Linguini", "Leash of Linguini", 5, 10);
  ...
  public void itShouldHaveAName() {
    ...
    assertEquals(
        "cast 5 Leash of Linguini ^ Leash of Linguini",
        testMe.toString(),
        "Unexpected toString value");
  }

  @Test
  public void itShouldCompareDuration() {
    ManaBurn d1 = new ManaBurn(3010, "Leash of Linguini", "Leash of Linguini", 1, 10);
    ManaBurn d1x = new ManaBurn(3010, "Leash of Linguini", "Leash of Linguini", 1, 10);
    ManaBurn d5 = new ManaBurn(3010, "Leash of Linguini", "Leash of Linguini", 5, 10);
