      ...
      assertThat(
          ...
          containsString(
              "Your ChibiBuddy&trade; <b>Ronald</b> is 3 days old and you last visited them "
                  + daysAgoString
                  + "."));
      assertThat(output, containsString("<tr><td>Alignment</td><td>XXX</td><td>[3/10]</td></tr>"));
      assertThat(output, containsString("<tr><td>Fitness</td><td>XXXX</td><td>[4/10]</td></tr>"));
      assertThat(
          output, containsString("<tr><td>Intelligence</td><td>XXXXX</td><td>[5/10]</td></tr>"));
      assertThat(
          output, containsString("<tr><td>Socialization</td><td>XXXXXX</td><td>[6/10]</td></tr>"));
      assertContinueState();
    }
  }
}
