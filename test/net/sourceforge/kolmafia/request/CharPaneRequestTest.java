...
class CharPaneRequestTest {
  ...
  class ShrunkenHead {
    ...
    void parseShrunkenHead() {
      var cleanups = new Cleanups(withProperty("shrunkenHeadZombieMonster"), withProperty("shrunkenHeadZombieAbilities"), withProperty("shrunkenHeadZombieHP"));
      ...
      try (cleanups) {
        ...
        assertThat("shrunkenHeadZombieAbilities", isSetTo("Hot Attack (33%), Spooky Attack (30%), HP Regen (37%)"));
    ...
    void parseShrunkenHeadCompact() {
      ...
      try (cleanups) {
        ...
        assertThat("shrunkenHeadZombieAbilities", isSetTo("Item Drop Bonus (29%), Physical Attack (23%), Hot Attack (22%), Cold Attack (26%)"));
