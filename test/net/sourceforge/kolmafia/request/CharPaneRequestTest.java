...
class CharPaneRequestTest {
    ...
    class Sweaty {
        ...
        void parseSweatiness(String responseHtml, int expectedValue) {
            var cleanups = new Cleanups(equip(EquipmentManager.PANTS, "designer sweatpants"), setProperty("sweat", 0));
        ...
        void recogniseNoSweatinessDisplayedMeansZeroIfPantsEquipped() {
            var cleanups = new Cleanups(equip(EquipmentManager.PANTS, "designer sweatpants"), setProperty("sweat", 11));
