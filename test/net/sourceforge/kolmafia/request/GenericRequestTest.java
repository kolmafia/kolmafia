...
public class GenericRequestTest {
  ...
  @Test
  public void itShouldReadEveryValueOfARepeatedFormField() {
    // A relay chat client's batched submit, with the password hash redacted.
    GenericRequest request = new GenericRequest("submitnewchat.php");
    request.addFormFields(
        "playerid=3469406&pwd=redacted&j=1&graf%5B%5D=%2Fwho+clan&graf%5B%5D=%2Fwho+challenge"
            + "&graf%5B%5D=%2Fwho+dread&graf%5B%5D=%2Fwho+foodcourt&graf%5B%5D=%2Fwho+games"
            + "&graf%5B%5D=%2Fwho+haiku&graf%5B%5D=%2Fwho+hardcore&graf%5B%5D=%2Fwho+newbie"
            + "&graf%5B%5D=%2Fwho+normal&graf%5B%5D=%2Fwho+pvp&graf%5B%5D=%2Fwho+radio"
            + "&graf%5B%5D=%2Fwho+talkie&graf%5B%5D=%2Fwho+trade&graf%5B%5D=%2Fwho+veteran",
        true);
