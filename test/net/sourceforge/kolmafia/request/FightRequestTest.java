...
public class FightRequestTest {
  ...
  @Test public void cursedMagnifyingGlassTest() throws IOException {
    KoLCharacter.reset("the Tristero");
    EquipmentManager.setEquipment(EquipmentManager.OFFHAND, ItemPool.get(ItemPool.CURSED_MAGNIFYING_GLASS));
