...
public class LatteRequestTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = { "Latte: Autumnal carrot Latte with a shake of cinnamon|pumpkin,carrot,cinnamon", "Latte: Blue chalk and cajun spice Latte with dwarf cream|chalk,cajun,dwarf", "Latte: Hellish lizard milk Latte dusted with flour|hellion,lizard,flour" })
